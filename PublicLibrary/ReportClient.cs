   ...
   public class ReportClient
    {
        ...
        /// </summary>
        public async Task<Model.HttpResponse> GetMessageReportAsync(List<string> msgIdList)
        {
            if (msgIdList == null)
            ...
            return new Model.HttpResponse(msg.StatusCode, msg.Headers, content);
        }
        ...
        public Model.HttpResponse GetMessageReport(List<string> msgIdList)
        {
            Task<Model.HttpResponse> task = Task.Run(() => GetMessageReportAsync(msgIdList));
            task.Wait();
            return task.Result;
        }
        ...
        /// </summary>
        public async Task<Model.HttpResponse> GetMessageSendStatusAsync(string msgId, List<string> registrationIdList, string data)
        {
        ...
        public Model.HttpResponse GetMessageSendStatus(string msgId, List<string> registrationIdList, string data)
        {
            Task<Model.HttpResponse> task = Task.Run(() => GetMessageSendStatusAsync(msgId, registrationIdList, data));
            task.Wait();
            return task.Result;
        }
        ...
        /// </summary>
        public async Task<Model.HttpResponse> GetMessageDetailReportAsync(List<string> msgIdList)
        {
            if (msgIdList == null)
                throw new ArgumentNullException(nameof(msgIdList));
        ...
        /// </summary>
        /// <param name="msgIdList">消息的 msg_id 列表，每次最多支持 100 个。</param>
        public Model.HttpResponse GetMessageDetailReport(List<string> msgIdList)
        {
            Task<Model.HttpResponse> task = Task.Run(() => GetMessageDetailReportAsync(msgIdList));
            task.Wait();
            return task.Result;
        }
        ...
        /// </summary>
        public async Task<Model.HttpResponse> GetUserReportAsync(string timeUnit, string startTime, int duration)
        {
        ...
        /// </param>
        public Model.HttpResponse GetUserReport(string timeUnit, string startTime, int duration)
        {
            Task<Model.HttpResponse> task = Task.Run(() => GetUserReportAsync(timeUnit, startTime, duration));
            task.Wait();
            return task.Result;
        }
    }

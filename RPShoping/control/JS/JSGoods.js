jQuery(document).ready(function () {
    ...
    //};
    jQuery("#list5").jqGrid({
        url: "/Contract/AfterService.asmx/GetProductList",
        datatype: "json",
        mtype: 'post',
        postData: { where: "" },
        ...
        colNames: ['序号', '商品名称', '上架状态', '类别', '主图', '商品描述', '价格', '备注', "产品分类id"],
                    colModel: [
                        { name: 'id', index: 'id', width: 55, align: "center", hidden: true },
                        { name: 'P_Name', index: 'P_Name', width: 80, align: "center" },
                        { name: 'p_state', index: 'p_state', width: 100, align: "center" },
                        ...
                        //{ name: 'P_Details', index: 'P_Details', width: 120, align: "center", hidden: true },
                        { name: 'P_Remark', index: 'P_Remark', width: 120, align: "center" },
                        { name: 'PS_ID', index: 'PS_ID', width: 10, align: "center", hidden: true },
                    ],
                    page: 1,
                    rowNum: 30,
                    rowList: [30, 50, 100],
    ...
    //function getproductsort(callback) {
        ...
        //}
        //$.ajax({
        //    url: "https://d.apicloud.com/mcm/api/tb_Product",// + encodeURIComponent(JSON.stringify(filter)),
        //    method: "get",
        //    headers: {
        ...
        //                var tempstr = "{'id':'" + data[i].id + "','imgsrc':'" + data[i].P_Image + "'}";
        //                imgkeylist.push(eval('('+tempstr+')'));
        //            }
        //        }
        //        callback("1", data);
        //    },
    ...
    $(document.body).on("click", "#add", function () {
        window.location.href = "GoodsEdit.aspx?m_id=" + _m_id;
    });
    //刷新
    ...
    $(document.body).on("click", "#edit", function () {
        ...
        if (ids.length <= 0 || ids.length > 1) {
            ...
            var temprowData = $("#list5").jqGrid("getRowData", ids[0]);
            window.location.href = "GoodsEdit.aspx?id=" + temprowData.id + "&m_id=" + _m_id;
        }
    });

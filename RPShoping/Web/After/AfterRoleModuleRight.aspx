<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfterRoleModuleRight.aspx.cs" Inherits="RPShoping.Web.After.AfterModuleRight" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>后台角色模块权限管理</title>
        ...
        <div class="datatb_all">
            <div class="datatb_all_mide">
                <div class="datatb_top">
                    <span class="top_title">后台角色模块权限设置</span>
...
<script src="../../control/JS/JSAfterRoleModuleRight.js"></script>
